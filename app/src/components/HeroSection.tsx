...
export default function HeroSection() {
    ...
    return (
        ...
        >
            ...
            <motion.div
                className="absolute top-[80px] md:top-[100px] left-0 right-0 z-20 flex flex-col md:flex-row items-start justify-between px-6 md:px-12 pointer-events-none md:pointer-events-auto"
                style={{
                    opacity: hudOpacity,
                }}
            >
            ...
            <motion.div
                className="absolute inset-0 z-15 flex flex-col items-center justify-center text-center px-4 md:px-0"
                style={{
                    y: textY,
                    opacity: textOpacity,
                }}
